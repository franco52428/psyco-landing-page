...
El objetivo primario es que una persona interesada converse con un asesor de Verdme. El objetivo secundario es que quien ya tiene cuenta pueda iniciar sesión.

- CTA primario: “Hablar con un asesor” en navegación y cierre.
- En la landing, dirigir las consultas de información y asesoría a `info@verdme.com`, y las de soporte a `support@verdme.com`. Mostrar ambos correos con su función en el footer.
- CTA secundario: “Iniciar sesión” o “Ver cómo funciona”.
- En `error.html`, explicar que el enlace no está disponible sin mostrar códigos técnicos. Ofrecer tres caminos claros: entrar al consultorio para quien ya usa Verdme, volver a la landing para quien explora y pedir ayuda para encontrar lo que buscaba.
- No decir “gratis”, “sin tarjeta”, “crear cuenta ahora” ni publicar precios sin una condición comercial vigente y documentada.
- Mantener un CTA primario claro en navegación y cierre; en el cierre, centrar el botón dentro de su columna tanto vertical como horizontalmente. El hero presenta el producto y accesos internos a los cinco módulos destacados, sin botones adicionales.
...
- En Planes y precios, presentar solo Basic por $99.000 COP mensuales, la lista concreta de características incluidas confirmada en `features.md` y las condiciones documentadas. No llamar módulos a todas las prestaciones ni afirmar que el plan incluye todo lo mostrado en la landing: podrán aparecer otras capacidades que no formen parte de Basic. “Historia clínica” se refiere al expediente y las notas organizadas por el profesional, el cifrado al alcance verificado de datos clínicos sensibles, y el acceso 24/7 no implica un SLA de disponibilidad ininterrumpida. Destacar que el usuario activa y cancela la licencia desde Verdme, sin permanencia, penalidad por cancelar, trabas ni costos ocultos. El detalle del periodo pagado, la conservación durante un año para reactivación y la solicitud posterior por soporte vive en los términos y la política de cancelación enlazados; no repetirlo en la nota comercial bajo la tarjeta. Ubicar esta sección después de Seguridad y antes del cierre para que la conversación con un asesor siga siendo la última invitación.
...
- En escritorio, la primera vista debe incluir el titular, la vista de producto y cinco accesos a las secciones destacadas: Procesos clínicos, Pacientes, Finanzas, Pagos online y Seguridad. Deben seguir ese orden y enlazar a contenido existente dentro de la página.
- La navegación superior usa en escritorio el mismo ancho máximo de 1320 px que el hero para alinear el borde derecho de Hablar con un asesor con la vista ilustrativa de Agenda. Muestra la marca a la izquierda y, agrupados a la derecha, un desplegable nativo de Funcionalidades, Iniciar sesión como enlace de texto sin fondo ni borde y con la misma tipografía, peso y color del disparador, y Hablar con un asesor como única acción destacada. El disparador se presenta como texto de navegación con un chevrón, sin contorno de botón; el panel flota con una sombra discreta. El panel se alinea al borde derecho del disparador y se cierra al elegir una opción, hacer clic fuera o pulsar Escape. El desplegable reúne, en este orden, Agenda (inicio), Procesos clínicos, Pacientes, Finanzas, Pagos online, Seguridad y Planes y precios, con anclas a las secciones existentes. En móvil puede reducirse a un icono con nombre accesible; mantener visible la acción de hablar con un asesor.
...
- La sección de pagos online coloca la demostración a la izquierda y el mensaje a la derecha en escritorio; en móvil, presenta primero el mensaje. Ambos deben caber completos en un pantallazo de escritorio, considerando la barra fija. Ajustar el espacio exterior y escalar uniformemente el contenedor visual según la altura disponible; preservar el interior del checkout aprobado.
